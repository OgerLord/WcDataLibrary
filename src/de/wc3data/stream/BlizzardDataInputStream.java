...
public class BlizzardDataInputStream
    ...
    public int readNByteInt(int numBytes)
            throws IOException {
    ...
    public char[] readChars(int charCount)
            throws IOException {
    ...
    public String readCharsAsString(int charCount)
            throws IOException {
        char[] c = readChars(charCount);
        for (int i = 0; i < charCount; i++) {
            if (c[i] == 0) {
    ...
    public String readCharsAsStringCheckNull(int charCount)
            throws IOException {
        char[] result = readChars(charCount);
        boolean isNull = true;
        for (int i = 0; i < charCount; i++) {
            if (result[i] != 0) {
                isNull = false;
