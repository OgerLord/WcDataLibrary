...
public class ParticleEmitter2Chunk {
	...
	public class ParticleEmitter2 {
		...
		public void load(BlizzardDataInputStream in) throws IOException {
			...
			time = in.readFloat();
			segmentColor = StreamUtils.loadFloatArray(in, 9);
			segmentAlpha = StreamUtils.loadByteArray(in, 3);
			segmentScaling = StreamUtils.loadFloatArray(in, 3);
		...
		public void save(BlizzardDataOutputStream out) throws IOException {
			...
			StreamUtils.saveFloatArray(out, segmentScaling);
